  ...
  <div class="app-container page-order">
    ...
    >
      ...
      >
        ...
        <div class="_m"  v-for="(goods, index) in item.goods" :key="index">
          <div class="_l">
            <van-image
              width="20vw"
              height="20vw"
          ...
          <div class="_mid">
            <p
              ...
              style="marginTop:0;"
            >{{goods.goods_name}}</p>
            <p class="_p1">规格:{{goods.option_name.join()}}</p>
        ...
        <div class="_b">
          <div class="_b-t">
            <span>共{{}}件商品 合计：</span>￥{{item.real_amount}}
          </div>
          <div class="_b-b">
            <div></div>
            <div>
              <div class="u-btn _btn0">已兑换</div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loadList() {
        api.member_integral_order_list({
          // status: this.active,
